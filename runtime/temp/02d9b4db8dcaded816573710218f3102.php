<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\phpStudy\WWW\1\ppgongshe\public/../application/index\view\rebate\rebateList.html";i:1528861024;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <table class="layui-table">
        ...
        <tbody class="news_content">
          <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
               <tr>
                <td>
                  <input type="checkbox" class="check" value="<?php echo $vo['user_id']; ?>"><div class="layui-unselect layui-form-checkbox" value="<?php echo $vo['user_id']; ?>" lay-skin=""><i class="layui-icon"></i></div>

                  </td>
                <td><?php echo $vo['user_name']; ?></td>
                <td><?php echo $vo['rebate_money']; ?></td>
                <td><?php echo $vo['regirect_time']; ?></td>
            <td>
              <a href="<?php echo url('Rebate/rebateShow'); ?>?user_id=<?php echo $vo['user_id']; ?>">查看</a>
            </td>
               </tr>
