<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\1\ppgongshe\public/../application/index\view\cate\cateAdd.html";i:1528974509;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body class="childrenBody">
	<form class="layui-form" method="post" action="<?php echo url('cate/cateAdd'); ?>" enctype="multipart/form-data" onsubmit="return checkform()">
		<div class="layui-form-item">
			<label class="layui-form-label">分类名称</label>
			<div class="layui-input-block">
				<input type="text" name="cat_name" id="cat_name" class="layui-input newsName" lay-verify="required" placeholder="请输入分类名称">
			</div>
		</div>
		<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="parent_id" class="newsLook" lay-filter="browseLook">
				        ...
				        <?php foreach($cate_data as $value): ?>
				        	<option value="<?php echo $value['cat_id']; ?>"><?php echo str_repeat("&nbsp;  ",$value['f']) ?><?php echo $value['cat_name']; ?></option>
				        <?php endforeach; ?>
				    </select>
				</div>
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="cat_desc" id="cat_desc" class="layui-input newsName" lay-verify="required" placeholder="分类描述">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">排序</label>
			<div class="layui-input-block">
				<input type="text" name="sort" id="sort" class="layui-input newsName" lay-verify="required" placeholder="分类描述">
			</div>
		</div>
		<div class="layui-form-item">
