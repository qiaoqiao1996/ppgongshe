<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpStudy\WWW\1\ppgongshe\public/../application/index\view\attribute\attrUpdate.html";i:1528541784;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body class="childrenBody" id="validForm">
	...
	<form class="layui-form" action="<?php echo url('Attribute/attrUpdate'); ?>" method="post">
		<div class="layui-form-item">
			<label class="layui-form-label">属性名称</label>
			<div class="layui-input-block">
				<input type="text" name="attr_name" id="attr_name" class="layui-input newsName" lay-verify="required" disabled="true" value="<?php echo $attr['attr_name']; ?>">
				<input type="hidden" name="attr_id" value="<?php echo $attr['attr_id']; ?>">
				<input type="hidden" name="attr_name" value="<?php echo $attr['attr_name']; ?>">
			</div>
		</div>
		...
		<div class="layui-inline">
				...
				<div class="layui-input-inline">
					...
					<select class="newsLook" name="type_id" lay-filter="browseLook">
						...
						<?php if(is_array($type) || $type instanceof \think\Collection || $type instanceof \think\Paginator): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['type_id'] == $attr['type_id']): ?>
			...
			<div class="layui-inline">
			    ...
			    <div class="layui-input-block userSex">
			    	<?php if($attr['attr_type'] == 1): ?>
								...
								<?php else: ?> 
								  <input type="radio" name="attr_type" value="1" title="参数">
			      	              <input type="radio" name="attr_type" value="2" title="规格" checked>
								<?php endif; ?>
