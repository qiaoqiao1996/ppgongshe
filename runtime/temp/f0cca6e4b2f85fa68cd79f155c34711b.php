<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudy\WWW\1\ppgongshe\public/../application/index\view\attr\attr_add.html";i:1528810027;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
            ...
            success:function(e) {
            	...
            	$.each(e,function(i,obj){
                    if(obj.attr_type==1){
                    	...
                    	str+="<input type='hidden' value='"+obj.attr_type+"' name='attr_type[]'>"
