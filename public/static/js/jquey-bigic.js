    ...
    $.fn.bigic = function () {
        ...
        Bigic.prototype.popup = function(){
            var sHtml = '',
                oThis = this;
            // 生成HTML 选中DOM节点
            sHtml += '<div id="popupBigic" class="popup-bigic" style="padding-top:225px;width:'+ this.nWinWid +'px;height:'+ this.nWinHei +'px;">' 
                  ...
                  +     '</div>'
                  +     '<img id="LoadingBigic" class="loading-bigic" src="__ROOT__/static/images/preloader.gif" />'
                  +  '</div>';
            $('body').append(sHtml);
